...
[version map](https://github.com/cakephp/migrations/wiki#version-map).
Versions marked as EOL no longer receive fixes.

## Reporting a Vulnerability

If you've found a security issue in CakePHP Migrations, please use the following procedure
